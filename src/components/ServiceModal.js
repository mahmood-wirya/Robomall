    ...
    <div>
      ...
      >
        ...
        <div className="container px-5 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className="mt-1">{services.address.city} - {services.address.street} - {services.address.number}</p>
                <p className="mt-1">Zip Code : {services.address.zipcode}</p>
                <p className="mt-1">Photo booth tattooed prism, portland taiyaki hoodie neutra typewriter</p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                <a className="text-indigo-500 leading-relaxed">{services.email}</a>
          ...
          <h2 className="text-sm title-font text-gray-500 tracking-widest">Computer repair technician</h2>
          <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{services.name.firstname} {services.name.lastname}</h1>
          <div className="flex mb-4">
            ...
            <p className="pl-1 pb-[6px] text-[12px] title-font text-gray-500 tracking-widest">
              ...
              <span className="text-gray-600 ml-3 pb-[6px]">4 Reviews</span>
            </div>
