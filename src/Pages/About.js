            ...
            <div className="flex flex-wrap -m-4">
              <div className="p-4 md:w-1/2 w-full">
                <div className="h-full bg-gray-100 p-8 rounded">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="block w-5 h-5 text-[#2DBCB7] mb-4" viewBox="0 0 975.036 975.036">
                  ...
                  <a className="inline-flex items-center">
                    ...
                    <span className="flex-grow flex flex-col pl-4">
                      ...
                      <span className="text-[#2DBCB7] text-sm">UI DEVELOPER</span>
                    </span>
                  </a>
                </div>
              </div>
                ...
                <div className="h-full bg-gray-100 p-8 rounded">
                  ...
                  <a className="inline-flex items-center">
                    ...
                    <span className="flex-grow flex flex-col pl-4">
                      ...
                      <span className="text-[#2DBCB7] text-sm">DESIGNER</span>
                    </span>
                  </a>
                </div>
              </div>
